...
- Input liveness: real sensor and pointer IO should auto-enable only when available. If device-orientation events go quiet or the tab is hidden, the field must return to neutral instead of preserving stale gravity.
